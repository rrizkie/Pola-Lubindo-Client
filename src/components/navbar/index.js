          ...
          {!localStorage.getItem("access_token") ? (
            <Typography variant="h6" className={classes.text}>
              <Button
                ...
                onClick={() => history.push(refCode ? `/login?ref=${refCode}` : "/login")}
              >
                Log in
              </Button>
              /
              <Button
                className={classes.button}
                onClick={() => history.push(refCode ? `/register?ref=${refCode}` : "/register")}
              >
                Daftar
              </Button>
            </Typography>
            ...
            <Typography variant="h6" className={classes.text}>
              <Button
                className={classes.button}
                onClick={() => history.push(refCode ? `/profile?ref=${refCode}` :"/profile")}
              >
                Profile
              </Button>
            </Typography>
